  ...
  return (
    <div>
        ...
        <section className='main_container'>
          ...
          <section className='head-research'>
            <h1>Research Domains</h1>
            <p>Browse through our curated collection of millions of academic papers across<br></br> specialized fields of study.</p>
          </section>
          ...
          <section className='categories'>
              <div className='category'>
                ...
                <p>Algorithms , systems and theory</p>
              </div>
              <div className='category'>
                <div>
              ...
              <div className='category'>
               ...
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sigma-icon lucide-sigma"><path d="M18 7V5a1 1 0 0 0-1-1H6.5a.5.5 0 0 0-.4.8l4.5 6a2 2 0 0 1 0 2.4l-4.5 6a.5.5 0 0 0 .4.8H17a1 1 0 0 0 1-1v-2"/></svg>
                ...
                <h2>Mathematics</h2>
                <p>Algebra, geometry, probability</p>
              </div>
              <div className='category'>
                <div>
                ...
                <h2>Statistics</h2>
                <p>Inference, regression, learning</p>
              </div>
              <div className='category'>
                <div>
